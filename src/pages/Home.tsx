    ...
    <div className="bg-black text-white min-h-screen">
      ...
      <section className="h-[200vh] bg-black relative">
        ...
        <div className="relative z-10 w-full mx-auto px-6 md:px-12 lg:px-16 pt-24 pb-16" style={{ maxWidth: '1500px' }}>
          <div className="grid grid-cols-1 lg:grid-cols-[4fr_7fr] gap-8 items-center">
            ...
            <div className="flex flex-col items-start text-left">
              <AnimatedHeading
                text="We build&#10;worlds."
                className="font-normal mb-6 text-white w-full"
                style={{ fontSize: 'clamp(3.5rem, 10vw, 7.5rem)', letterSpacing: '-0.04em', lineHeight: 0.92 }}
                delay={200}
                charDelay={32}
              />

              <FadeIn delay={1100} className="text-base md:text-lg text-gray-300 mb-10 max-w-md" style={{ lineHeight: 1.65 }}>
        ...
        <FadeIn delay={2000} className="absolute bottom-8 left-1/2 -translate-x-1/2 z-10">
          <div className="liquid-glass rounded-full px-4 py-2 border border-white/20">
      ...
      {/* ─── TICKER ───────────────────────────────────────── */}
      <div className="bg-black py-4 overflow-hidden" style={{ borderTop: '1px solid rgba(255,255,255,0.08)', borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
        <div className="flex gap-12 whitespace-nowrap" style={{ animation: 'ticker 28s linear infinite' }}>
          {[...TICKER_ITEMS, ...TICKER_ITEMS].map((item, i) => (
            <span key={i} className={`text-xs uppercase tracking-widest ${i % 2 === 0 ? 'text-gray-300' : 'text-white/20'}`}>
              {i % 2 === 0 ? item : '✦'}
            </span>
          ))}
        </div>
      ...
      <section id="games" className="bg-black py-16">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-end justify-between mb-8 px-6 md:px-12 lg:px-16">
            <div>
              <SectionReveal><p className="text-xs tracking-widest uppercase text-gray-300 mb-2">Games</p></SectionReveal>
              <SectionReveal delay={60}><h2 className="text-4xl md:text-5xl font-normal" style={{ letterSpacing: '-0.03em' }}>Made to be played.</h2></SectionReveal>
            </div>
            <SectionReveal>
              <Link to="/games">
                <button className="liquid-glass border border-white/20 text-white px-5 py-2 rounded-lg text-sm font-medium hover:bg-white hover:text-black transition-colors">
                  View All →
                </button>
              </Link>
            </SectionReveal>
          ...
          {games.length === 0 ? (
            <div className="flex gap-4 px-6 overflow-hidden justify-center">
              {[...Array(3)].map((_, i) => (
                <div key={i} className="liquid-glass rounded-3xl border border-white/5 animate-pulse flex-shrink-0" style={{ width: 260, height: 380 }} />
              ))}
            </div>
          ) : (
            <SectionReveal>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-3">
          {[
            ...
            <SectionReveal key={stat.label} delay={i * 80}>
              <div className="liquid-glass rounded-2xl px-6 py-8 text-center border border-white/10">
                <p className="text-4xl md:text-5xl font-normal mb-2" style={{ letterSpacing: '-0.04em' }}>{stat.value}</p>
      ...
      <section id="brands" className="bg-black py-28 px-6 md:px-12 lg:px-16 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              <SectionReveal><p className="text-xs tracking-widest uppercase text-gray-300 mb-3">For Brands</p></SectionReveal>
              <SectionReveal delay={60}>
                <h2 className="text-4xl md:text-5xl lg:text-6xl font-normal mb-6" style={{ letterSpacing: '-0.03em', lineHeight: 1.0 }}>
                  Your brand,<br />in the game.
                </h2>
              </SectionReveal>
              <SectionReveal delay={120}>
                <p className="text-base md:text-lg text-gray-300 mb-8" style={{ lineHeight: 1.7 }}>
                ...
                <div className="space-y-5 mb-8">
                  {[
                    ...
                    <div key={item.n} className="flex items-start gap-4">
                      <div className="liquid-glass rounded-xl w-9 h-9 flex-shrink-0 flex items-center justify-center border border-white/20 text-xs font-light" style={{ marginTop: 2 }}>
                        {item.n}
                      </div>
                      <div>
            ...
            <SectionReveal>
              <div className="liquid-glass rounded-2xl overflow-hidden relative group border border-white/20" style={{ height: 480 }}>
                ...
                <div className="absolute top-5 left-5 z-10">
                  <div className="liquid-glass rounded-xl px-3 py-1 border border-white/20">
                    <span className="text-xs text-gray-300 uppercase tracking-wider">Brand Activation</span>
                  </div>
                </div>
                <div className="absolute bottom-0 left-0 right-0 p-6 z-10">
                  <h3 className="text-2xl font-semibold mb-1" style={{ letterSpacing: '-0.02em' }}>This could be you.</h3>
                  <p className="text-sm text-gray-300">Your brand, built into the world players love.</p>
                </div>
              </div>
            </SectionReveal>
          </div>
        ...
        <section className="bg-black py-24 px-6 md:px-12 lg:px-16">
          <div className="max-w-7xl mx-auto">
            <div className="flex items-end justify-between mb-10">
              <div>
                <SectionReveal><p className="text-xs tracking-widest uppercase text-gray-300 mb-2">Blog</p></SectionReveal>
                <SectionReveal delay={60}><h2 className="text-4xl md:text-5xl font-normal" style={{ letterSpacing: '-0.03em' }}>News & Updates</h2></SectionReveal>
              </div>
              <SectionReveal>
                <Link to="/blog">
                  <button className="hidden md:block liquid-glass border border-white/20 text-white px-6 py-2 rounded-lg text-sm font-medium hover:bg-white hover:text-black transition-colors">
                    All Posts →
                  </button>
                </Link>
              </SectionReveal>
      ...
      <section id="studio" className="bg-black py-28 px-6 md:px-12 lg:px-16">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          <SectionReveal>
            <div className="liquid-glass rounded-2xl overflow-hidden relative group border border-white/20" style={{ height: 520 }}>
              <video autoPlay loop muted playsInline className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105">
          ...
          <div>
            <SectionReveal><p className="text-xs tracking-widest uppercase text-gray-300 mb-3">Studio</p></SectionReveal>
            <SectionReveal delay={60}><h2 className="text-4xl md:text-5xl font-normal mb-6" style={{ letterSpacing: '-0.03em', lineHeight: 1.0 }}>We are Switch.</h2></SectionReveal>
            <SectionReveal delay={120}>
              <p className="text-base md:text-lg text-gray-300 mb-5" style={{ lineHeight: 1.7 }}>
            ...
            <SectionReveal delay={180}>
              <p className="text-base text-gray-300 mb-8" style={{ lineHeight: 1.7 }}>
            ...
            <SectionReveal delay={240}>
              <div className="flex flex-wrap gap-2">
                {['Game Design', 'World Building', 'Lua Scripting', 'Brand Strategy', 'Community', 'Monetisation'].map(tag => (
                  <div key={tag} className="liquid-glass rounded-xl px-4 py-2 border border-white/20">
      ...
      <section className="bg-black py-24 px-6 md:px-12 lg:px-16">
        <div className="max-w-7xl mx-auto">
          <SectionReveal><p className="text-xs tracking-widest uppercase text-gray-300 mb-3">How We Work</p></SectionReveal>
          <SectionReveal delay={60}>
            <h2 className="text-4xl md:text-5xl font-normal mb-12" style={{ letterSpacing: '-0.03em' }}>
            ...
            {[
              ...
              <SectionReveal key={step.n} delay={i * 80}>
                <div className="liquid-glass rounded-2xl p-6 border border-white/10 h-full">
                  <p className="text-xs uppercase tracking-widest text-gray-300 mb-4">{step.n}</p>
                  <h3 className="text-lg font-medium mb-2" style={{ letterSpacing: '-0.02em' }}>{step.title}</h3>
                  <p className="text-sm text-gray-300" style={{ lineHeight: 1.6 }}>{step.desc}</p>
                </div>
              </SectionReveal>
            ))}
          </div>
      ...
      <section id="contact" className="bg-black py-32 px-6 md:px-12 lg:px-16 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <SectionReveal><p className="text-xs tracking-widest uppercase text-gray-300 mb-4">Let's Build</p></SectionReveal>
          <SectionReveal delay={60}>
            <h2 className="font-normal mb-6" style={{ fontSize: 'clamp(2.8rem, 7vw, 5.5rem)', letterSpacing: '-0.04em', lineHeight: 0.95 }}>
              Ready to Switch?
            </h2>
          </SectionReveal>
          <SectionReveal delay={120}>
            <p className="text-base md:text-lg text-gray-300 mb-10 max-w-lg mx-auto" style={{ lineHeight: 1.7 }}>
